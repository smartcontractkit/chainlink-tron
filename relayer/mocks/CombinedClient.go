...
func (_m *CombinedClient) TriggerSmartContractWithData(from address.Address, contractAddress address.Address, data string, feeLimit int32, tAmount int64) (*fullnode.TriggerSmartContractResponse, error) {
