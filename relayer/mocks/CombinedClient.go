...
import (
	...
	common "github.com/smartcontractkit/chainlink-tron/relayer/gotron-sdk/pkg/http/common"

	fullnode "github.com/smartcontractkit/chainlink-tron/relayer/gotron-sdk/pkg/http/fullnode"

	mock "github.com/stretchr/testify/mock"

	soliditynode "github.com/smartcontractkit/chainlink-tron/relayer/gotron-sdk/pkg/http/soliditynode"
)
...
func (_m *CombinedClient) FullNodeClient() *fullnode.Client {
	...
	if len(ret) == 0 {
		panic("no return value specified for FullNodeClient")
	}

	var r0 *fullnode.Client
	if rf, ok := ret.Get(0).(func() *fullnode.Client); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*fullnode.Client)
		}
	}
...
func (_m *CombinedClient) GetAccountFullNode(accountAddress address.Address) (*soliditynode.GetAccountResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetAccountFullNode")
	}
...
func (_m *CombinedClient) GetBlockByNumFullNode(num int32) (*soliditynode.Block, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetBlockByNumFullNode")
	}
...
func (_m *CombinedClient) GetContract(_a0 address.Address) (*fullnode.GetContractResponse, error) {
	ret := _m.Called(_a0)
...
func (_m *CombinedClient) GetNowBlockFullNode() (*soliditynode.Block, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetNowBlockFullNode")
	}
...
func (_m *CombinedClient) GetTransactionInfoByIdFullNode(txhash string) (*soliditynode.TransactionInfo, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetTransactionInfoByIdFullNode")
	}
...
func (_m *CombinedClient) SolidityClient() *soliditynode.Client {
	...
	if len(ret) == 0 {
		panic("no return value specified for SolidityClient")
	}

	var r0 *soliditynode.Client
	if rf, ok := ret.Get(0).(func() *soliditynode.Client); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*soliditynode.Client)
		}
	}
...
func (_m *CombinedClient) TriggerConstantContractFullNode(from address.Address, contractAddress address.Address, method string, params []interface{}) (*soliditynode.TriggerConstantContractResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for TriggerConstantContractFullNode")
	}
...
// NewCombinedClient creates a new instance of CombinedClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
