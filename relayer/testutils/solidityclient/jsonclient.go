...
type SolidityClient interface {
	Do(*http.Request) (*http.Response, error)
}

var _ SolidityClient = &MockSolidityClient{}
...
func NewTronSolidityClient(baseURL string, client SolidityClient) *TronSolidityClient {
...
func (tc *TronSolidityClient) request(method string, endpoint string, reqBody interface{}, responseBody interface{}) error {
...
func (tc *TronSolidityClient) post(endpoint string, reqBody, responseBody interface{}) error {
	return tc.request("POST", endpoint, reqBody, responseBody)
}

func (tc *TronSolidityClient) get(endpoint string, responseBody interface{}) error {
