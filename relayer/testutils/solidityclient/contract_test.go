...
var expectedEstimateEnergy = &EnergyEstimateResult{
	Result: ReturnEnergyEstimate{
		Result: true,
	},
	EnergyRequired: 1082,
}

var expectedTriggerConstantContract = &TriggerConstantContractResponse{
	Result: TriggerConstantContractResult{
		Result: true,
	},
	EnergyUsed: 541,
	...
	Transaction: TriggerConstantTransaction{
